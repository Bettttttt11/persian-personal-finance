...
export async function migrate(repo){
  ...
  const defaults={schema_version:SCHEMA_VERSION,default_currency:'IRR',storage_currency:'IRR',session_timeout:'1h',pin_enabled:!!repo.env?.BOT_PIN,keep_original_receipts:false,receipt_quality:78,receipt_max_side:1600,budget_thresholds:[80,90,100]};
